    ...
    >
      <div
        ...
        className={cn(
          ...
          'h-[90vh] rounded-t-xl',
          'md:h-auto md:max-h-[90vh] md:max-w-lg md:rounded-lg',
          'animate-in fade-in-0 slide-in-from-bottom-4 md:slide-in-from-bottom-0 md:zoom-in-95',
          className
        )}
      >
        {/* Fixed Header */}
        <div className="flex-shrink-0 p-4 pt-6 md:p-6 md:pb-4 border-b border-gray-100">
          {title && (
            <h2 id="modal-title" className="text-lg font-semibold text-gray-900 pr-10">
              {title}
            </h2>
          )}
          <button
        ...
        {/* Scrollable Body */}
        <div className="flex-1 overflow-y-auto p-4 md:p-6 md:pt-4">{children}</div>
        {/* Fixed Footer */}
        {footer && (
          <div className="flex-shrink-0 p-4 md:p-6 md:pt-4 border-t border-gray-100 bg-white">
            {footer}
          </div>
        )}
      </div>
